...
export function FeaturePlaceholderPage({ feature }: { feature: string }) {
  ...
  return <><div><p className="eyebrow">ANTARCTICA WMS</p><h1 className="page-title">{label}</h1></div><Card className="mt-8 flex min-h-72 flex-col items-center justify-center text-center"><Construction className="mb-4 size-10 text-sky-400" /><h2 className="text-lg font-semibold text-slate-50">Module foundation ready</h2><p className="mt-2 text-sm text-slate-400">This workspace is ready for the {label} workflow.</p></Card></>
}
